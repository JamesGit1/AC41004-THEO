...
<div class="container index-content-box border">
  <div class="row">
    <div class="col">
      <img src="images/theo-logo2.png" class="img-fluid" alt="Theo Health Logo" id="indexImage" />
      <h3>Coming Soon..</h3>
      <p class="home-text">
      ...
      <a href="./create-account.php" class="btn button-orange" role="button">Sign Up</a>
    </div>
  </div>
</div>
